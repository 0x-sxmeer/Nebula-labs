...
const SwapCard = () => {
    ...
    const {
        ...
        routes, selectedRoute, loading, error, isRefreshing,
        balance, hasSufficientBalance, loadingBalance,
        gasPrice, autoRefresh, timeLeft, slippage,
        availableBridges, availableExchanges, disabledBridges, disabledExchanges,
        setFromChain, setToChain, setFromToken, setToToken, setFromAmount,
        setSlippage, setSelectedRoute, setAutoRefresh, setIsExecuting, switchTokens, refreshRoutes,
        setDisabledBridges, setDisabledExchanges,
        customToAddress, setCustomToAddress,
        checkBalance
    } = useSwap(walletAddress, chain?.id, routePriority === 'return' ? 'CHEAPEST' : (routePriority === 'gas' ? 'CHEAPEST' : 'FASTEST'));
